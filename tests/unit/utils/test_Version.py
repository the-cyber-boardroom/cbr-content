...
import cbr_content
from cbr_content.utils.Version import Version, version
...
class test_Version(TestCase):
    ...
    def test_path_code_root(self):
        assert self.version.path_code_root() == cbr_content.path

    def test_path_version_file(self):
        with self.version as _:
            assert parent_folder(_.path_version_file()) == cbr_content.path
